              ...
              <table className="w-full min-w-[860px] text-left">
                ...
                <tbody className="divide-y divide-gray-100 dark:divide-gray-900">
                  ...
                  <tr className="bg-indigo-50/45 dark:bg-indigo-950/15">
                    <td className="py-3 pr-5 align-top"><Textarea value={actionTitle} onChange={(e) => setActionTitle(e.target.value)} placeholder="Describe the action to complete..." aria-label="Action" className="min-h-[84px] resize-y bg-white text-sm dark:bg-gray-950" /></td>
